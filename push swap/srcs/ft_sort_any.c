...
static void	ft_instruction_execution(t_params *params, t_moves *moves)
{
...
static void ft_begin_sorting(t_params *params)
{
    ...
    while (params->num_of_el_in_b != 0)
    {
        ...
        ft_instruction_execution(params, move);
    }
    if ((ft_min_el_position(params->a, params->min)) >
	params->num_of_el_in_a / 2)
    {
